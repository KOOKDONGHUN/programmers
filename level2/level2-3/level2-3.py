...
#     log_dict = dict()
#
#     for one_log in record:
#         log = one_log.split(" ")
#
#         if log[0] == "Enter":
#             log_list.append([log[1],"님이 들어왔습니다."])
#             log_dict[log[1]] = log[2]
#         elif log[0] == "Leave":
#             log_list.append([log[1],"님이 나갔습니다."])
#         else:
#             log_dict[log[1]] = log[2]
#
#     for i in range(len(log_list)):
#         answer.append(log_dict[log_list[1][0]] + log_list[1][1])
#     return answer
